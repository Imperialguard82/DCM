<!DOCTYPE html>
  ...
  <html lang="en" >
    ...
    <nav class="navbar navbar-expand-lg z-index-3 py-3">
        <div class="container">
            <button class="btn bg-gradient-primary my-1 me-1">logout</button>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item pb-2">
                        <a class="nav-link" href="">
                            ...
                            <span class="nav-link-text ms-1">Therapists</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="">
                        ...
                        <span class="nav-link-text ms-1">T&C's</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="">
                    ...
                    <li class="nav-item">
                        ...
                        <span class="nav-link-text ms-1">F&Q's</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="">
